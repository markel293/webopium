...
<head>
    ...
    <title>Opium Barcelona ENTRADAS © 2026 Costa Este</title>
...
<body class="bodymainpage">
    ...
    <div class="divfotofondoVIP">
        <img class="fotofondoVIP" src="../img/fondocalendario.png" alt="Opium Barcelona ENTRADAS" />
    </div>
    ...
    <div class="divpresentacionvip">
        ...
        <p>Opium Barcelona © 2026 Costa Este</p>
    </div>
    ...
    <?php if ($evento): ?>
        <div class="diveventosENT">
            <div class="cuadroseventosENT">
                ...
                <a href="../OpiumBarcelona/infovipbcn.php" class="botonentradasENT">RESERVA VIP</a>
            </div>
        </div>
    ...
    <p class="textoh5MP">Opium Barcelona © 2026 Costa Este – Todos los derechos reservados</p>
    <br>
