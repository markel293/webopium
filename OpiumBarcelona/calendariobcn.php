...
<html lang="es">
  <head>
    ...
    <title>Opium Barcelona CALENDARIO © 2025 Costa Este</title>
  ...
  <body class="bodymainpage">
    ...
    <?php
      ...
      // Consulta para guardar eventos de Opium Barcelona (id_local=1) en junio de 2025
      ...
      if ($result && $result->num_rows > 0) {
          ...
          while ($evento = $result->fetch_assoc()) {
              ...
              if (!empty($evento['foto'])) {
                  ...
                  // Este else es por si añadrieramos una imagen por defecto en el caso que no haya flyer (TBA por ej)
              }
