<?php
/**
 * SEGURETAT MÀSTER: CONNEXIÓ AMB STRIPE
        ...
        $checkout_session = \Stripe\Checkout\Session::create([
            ...
            'line_items' => [[
                'price_data' => [
                    'currency' => 'eur',
                    'product_data' => [
                        'name' => "Opium Barcelona - " . $lote['nom_event'],
                        // Afegim Nom del Lot, Data i Titular a la descripció
            ...
            'mode' => 'payment',
            'success_url' => "http://192.168.77.111/auth/exito.php?session_id={CHECKOUT_SESSION_ID}&id_client=$idcliente&id_lot=$idlot&dia=$dia",
            'cancel_url' => "http://192.168.77.111/OpiumBarcelona/entradasbcn.php?dia=$dia",
        ]);
